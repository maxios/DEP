...
- [How-To: Add DEP Metadata to Existing Docs](add-dep-metadata.md) ○ `high` — human-author
- [How-To: Assemble a Context Bundle](assemble-a-context-bundle.md) ● `high` — ai-agent, human-author
- [How-To: Configure Governance](configure-governance.md) ○ `high` — project-lead, human-author
